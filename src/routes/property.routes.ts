...
router.post('/', upload.single('image'), (req, res, next) => propertyController.create(req, res, next));
router.put('/:id', upload.single('image'), (req, res, next) => propertyController.update(req, res, next));
